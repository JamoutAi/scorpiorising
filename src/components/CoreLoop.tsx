...
export function CoreLoop() {
  return (
    <section id="how" className="bg-mist py-24">
      <div className="mx-auto max-w-6xl px-5">
        ...
        <div className="mt-14 grid gap-8 md:grid-cols-3">
          {steps.map((s, i) => (
            <div
              key={s.title}
              className="rounded-2xl border border-ink/5 bg-paper p-8 shadow-sm"
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-ink text-mint">
                {i + 1}
              </div>
